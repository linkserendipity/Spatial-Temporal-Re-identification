...
# Load model
#---------------------------
# model_path = '../ST_model' #!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!! model_path
def load_network(network):
    save_path = os.path.join(model_path, name,'net_%s.pth'%opt.which_epoch)
...
scipy.io.savemat(model_path+'/'+name+'/'+'pytorch_result.mat', result)
